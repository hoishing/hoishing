...
I love coding, to me it's an enlightening✨ process. No matter frontend, backend, apps, task automation, data mining, machine learning, algo trading... I like them all.
...
| [ZERO][ZERO] Turn Base Strategy      | ![][swift] | iOS                          | game      |
| [認識佛教][認識佛教]                 |   obj-c    | iOS < v10                    | education |
| 好孩子小莉                           | ![][swift] | iOS                          | education |
...
[jekyll]: https://api.iconify.design/logos/jekyll.svg?width=60
