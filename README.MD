...
|:--------------------------------- |:------------------------------------------------:|:-------------------------------------------------------------------------------------------------- |
| [Speech Recognition][voice-recog] | [PWA][pwa] + [Alpine.js][alpine] + [UnoCSS][uno] | quick and easy speech synthesis PWA powered by Google Web Speech API 🚀 [launch app][launch-recog] | 
